 ...
 */
public class TimePartitionedDataPublisherWithHiveRegistration extends TimePartitionedDataPublisher {

    private final HiveRegistrationPublisher hivePublisher;

    public TimePartitionedDataPublisherWithHiveRegistration(State state) throws IOException {
        super(state);
