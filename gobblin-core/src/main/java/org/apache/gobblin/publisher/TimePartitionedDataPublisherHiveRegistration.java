...
/**
 * Created by deepak.batra on 29/01/18.
 */
public class TimePartitionedDataPublisherHiveRegistration extends TimePartitionedDataPublisher {

    private final HiveRegistrationPublisher hivePublisher;

    public TimePartitionedDataPublisherHiveRegistration(State state) throws IOException {
        super(state);
