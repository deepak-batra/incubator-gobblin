...
public class HttpRequestResponseRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static gobblin.http.HttpRequestResponseRecord.Builder newBuilder() {
    return new gobblin.http.HttpRequestResponseRecord.Builder();
  }
   ...
   * @return A new HttpRequestResponseRecord RecordBuilder
   */
  public static gobblin.http.HttpRequestResponseRecord.Builder newBuilder(gobblin.http.HttpRequestResponseRecord.Builder other) {
    return new gobblin.http.HttpRequestResponseRecord.Builder(other);
  }
   ...
   * @return A new HttpRequestResponseRecord RecordBuilder
   */
  public static gobblin.http.HttpRequestResponseRecord.Builder newBuilder(gobblin.http.HttpRequestResponseRecord other) {
    return new gobblin.http.HttpRequestResponseRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HttpRequestResponseRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(gobblin.http.HttpRequestResponseRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(gobblin.http.HttpRequestResponseRecord other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestUrl)) {
        this.requestUrl = data().deepCopy(fields()[0].schema(), other.requestUrl);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpRequestResponseRecord.Builder setRequestUrl(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpRequestResponseRecord.Builder clearRequestUrl() {
      requestUrl = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpRequestResponseRecord.Builder setMethod(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpRequestResponseRecord.Builder clearMethod() {
      method = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpRequestResponseRecord.Builder setContentType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpRequestResponseRecord.Builder clearContentType() {
      contentType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpRequestResponseRecord.Builder setStatusCode(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpRequestResponseRecord.Builder clearStatusCode() {
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpRequestResponseRecord.Builder setBody(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpRequestResponseRecord.Builder clearBody() {
      body = null;
