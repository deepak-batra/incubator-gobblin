...
public class HttpOperation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static gobblin.http.HttpOperation.Builder newBuilder() {
    return new gobblin.http.HttpOperation.Builder();
  }
   ...
   * @return A new HttpOperation RecordBuilder
   */
  public static gobblin.http.HttpOperation.Builder newBuilder(gobblin.http.HttpOperation.Builder other) {
    return new gobblin.http.HttpOperation.Builder(other);
  }
   ...
   * @return A new HttpOperation RecordBuilder
   */
  public static gobblin.http.HttpOperation.Builder newBuilder(gobblin.http.HttpOperation other) {
    return new gobblin.http.HttpOperation.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HttpOperation>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(gobblin.http.HttpOperation.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(gobblin.http.HttpOperation other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.keys)) {
        this.keys = data().deepCopy(fields()[0].schema(), other.keys);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpOperation.Builder setKeys(java.util.Map<java.lang.String,java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpOperation.Builder clearKeys() {
      keys = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpOperation.Builder setQueryParams(java.util.Map<java.lang.String,java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpOperation.Builder clearQueryParams() {
      queryParams = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpOperation.Builder setHeaders(java.util.Map<java.lang.String,java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpOperation.Builder clearHeaders() {
      headers = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpOperation.Builder setBody(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gobblin.http.HttpOperation.Builder clearBody() {
      body = null;
